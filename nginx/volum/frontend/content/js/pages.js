...
function timeShow_message2() {
	if (document.querySelector(".showMessage2") && document.querySelector(".showMessage2").style.display == "block") {
		hideMessage2 = false;
		document.querySelector(".showMessage2").style.display = "none";
	} else if (document.querySelector(".showMessage") && document.querySelector(".showMessage").style.display == "block") {
		document.querySelector(".showMessage2").style.display = "none";
...
function infosMatchs(cordon) {
	...
	if (
		...
		// alert("null");
		if (window.socketGame != "null" && window.socketGame.readyState == 1) {
